...
public class AssignmentsAugust07 {
	...
	public void test() throws InterruptedException {
		...
		Select sce = new Select(driver.findElement(By.id("input-payment-zone")));
		sce.selectByVisibleText("Ontario");
		Thread.sleep(2000);
...
//		Thread.sleep(5000);
		...
		driver.findElement(By.cssSelector("#collapse-payment-method > div > div.buttons > div > input:first-of-type"))
				.click();
